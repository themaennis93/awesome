...
vicious.register(battwidget, vicious.widgets.bat, '$1 $2 $3', 60, 'BAT0')
--  Network usage widget
-- Initialize widget,
netwidget = widget({ type = "textbox" })
-- Register widget
vicious.register(netwidget, vicious.widgets.net, '<span color="#CC9393">${wlan0 down_kb}</span> <span color="#93CC93">${wlan0 up_kb}</span>', 3)
--Create a textclock widget
mytextclock = awful.widget.textclock({ align = "right" })
--datewidget
-- Initialize widget
--idatewidget = wibox.widget.textbox()
-- Register widget
...
-- Initialize static memory widget
-- Initialize widget
...
vicious.register( volumewidget, vicious.widgets.volume, "Volume : $2 $1%", 1, "Master" )
